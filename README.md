...
- **프로젝트 소개 영상**: [MFC 팀 프로젝트 슬라이드 쇼](https://www.youtube.com/watch?v=1uwdepDfXG4) 
...
- **좀비 AI**: 플레이어를 추적하는 지능형 좀비들 (33% 확률로 랜덤 이동, 67% 확률로 플레이어 추적)
- **안전지대 시스템**: 플레이어가 생성할 수 있는 임시 안전지대 (3초 쿨타임)
...
본 프로젝트는 C++ MFC 프레임워크를 활용한 게임 개발과 팀 협업 능력을 보여주는 대표적인 포트폴리오입니다.
